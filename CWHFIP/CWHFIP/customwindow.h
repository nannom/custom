...
public:
    ...
    LPCWSTR title;
    Window();
    Window(LPCWSTR _title, int _width, int _heigth);
    Window(LPCWSTR _title, int _width, int _heigth, COLORREF _backcolor);
    Window(LPCWSTR _title, int _width, int _heigth, COLORREF _backcolor, DWORD style, DWORD exstyle);
    Window(LPCWSTR _title, int _width, int _heigth, COLORREF _backcolor, HICON icon, HCURSOR cursor);
    Window(LPCWSTR _title, int _width, int _heigth, COLORREF _backcolor, Window* _window, HICON icon, HCURSOR cursor, DWORD style, DWORD exstyle);
    Window(LPCWSTR _title, int _width, int _heigth, COLORREF _backcolor, HICON icon, HCURSOR cursor, DWORD style, DWORD exstyle);
    ~Window();
    ...
    void setwindowpos(int x, int y, int _width, int _heigth, UINT style = SWP_NOZORDER, HWND hWnd2 = nullptr);
};
class CREATE_TOOL
{
public:
...
public:
    ...
    LPCSTR title;
    Window();
    Window(LPCSTR _title, int _width, int _heigth);
    Window(LPCSTR _title, int _width, int _heigth, COLORREF _backcolor);
    Window(LPCSTR _title, int _width, int _heigth, COLORREF _backcolor, DWORD style, DWORD exstyle);
    Window(LPCSTR _title, int _width, int _heigth, COLORREF _backcolor, HICON icon, HCURSOR cursor);
    Window(LPCSTR _title, int _width, int _heigth, COLORREF _backcolor, Window* _window, HICON icon, HCURSOR cursor, DWORD style, DWORD exstyle);
    Window(LPCSTR _title, int _width, int _heigth, COLORREF _backcolor, HICON icon, HCURSOR cursor, DWORD style, DWORD exstyle);
    ~Window();
...
public:
    ...
    void box(COLORREF color, int x1, int y1, int x2, int y2, COLORREF filled = -1, int width = 1);
    void circle(COLORREF color, int x1, int y1, int x2, int y2, COLORREF filled = (COLORREF)-1, int width = 1);
